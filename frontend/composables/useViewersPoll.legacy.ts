/**
 * ARCHIVED: Per-unit viewer counts (Realtime postgres_changes on units).
 * Restore by renaming back to useViewersPoll.ts and re-wiring unit page + UnitCard + layout.
 */
